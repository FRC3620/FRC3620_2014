...
public class SensorSubsystem extends Subsystem {
    ...
    public void init() {
        ...
        System.out.println("Sensor subsystem is initializing");
    ...
    public void modeChanged() {
          if(Robot.getCurrentRobotMode() == RobotMode.DISABLED){
           Robot.sensorSubsystem.sendToArduino(1);
        System.out.print("disabled periodic");
          }
    }
    ...
    public void sendToArduino(int i) {
        ...
        System.out.println("Set arduino to" + i);
        if ((i & 1) != 0) {
            arduino1.set(true);
        } else {
            arduino1.set(false);
