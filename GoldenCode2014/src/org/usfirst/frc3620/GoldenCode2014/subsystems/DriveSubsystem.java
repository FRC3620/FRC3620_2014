...
public class DriveSubsystem extends Subsystem {
    ...
    public void arcadeDrive(GenericHID hid) {
        SmartDashboard.putNumber("js.x", hid.getX());
        SmartDashboard.putNumber("js.y", hid.getY());
        SmartDashboard.putNumber("js.z", hid.getZ());
        SmartDashboard.putNumber("js.throttle", hid.getThrottle());
        SmartDashboard.putNumber("js.twist", hid.getTwist());
    ...
    public void allStop() {
        // TODO rework these to use the RobotDrive objects
