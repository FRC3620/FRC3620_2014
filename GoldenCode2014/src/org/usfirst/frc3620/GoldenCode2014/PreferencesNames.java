...
public class PreferencesNames {
    ...
    public static final String AUTONOMOUS_CHOICE_VISION = "Vision";
    public static final String AUTONOMOUS_CHOICE_MOVE_ONLY = "Move Only";
    public static final String AUTONOMOUS_CHOICE_VISION_TEST = "Vision Test";

    public static final String[] AUTONOMOUS_ALL_CHOICES = new String[]{
        AUTONOMOUS_CHOICE_NONE,
        AUTONOMOUS_CHOICE_TWO_BALL,
        AUTONOMOUS_CHOICE_VISION,
        AUTONOMOUS_CHOICE_MOVE_ONLY,
        AUTONOMOUS_CHOICE_VISION_TEST,
    };
}
