...
public class OI {
    ...
    public OI() {
        ...
        intakeReverseButton = new JoystickButton(driveJoystick, 5);
        intakeReverseButton.whileHeld(new ReverseIntakeCommand());
        cockAndShootStateButton = new JoystickButton(driveJoystick, 1);
        cockAndShootStateButton.whenPressed(new CockAndShootState());
        extendIntakeButton = new JoystickButton(driveJoystick, 6);
        ...
        SmartDashboard.putData("AutonomousWait2", new AutonomousWait2());
