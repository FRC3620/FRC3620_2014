...
public class OI {
    ...
    public OI() {
        ...
        intakeReverseButton = new JoystickButton(joystick1, 5);
        intakeReverseButton.whileHeld(new ExtendIntakeCommand());
        ...
        cockAndShootButton = new JoystickButton(joystick1, 12);
